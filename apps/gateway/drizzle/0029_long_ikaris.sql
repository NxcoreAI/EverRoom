CREATE TABLE IF NOT EXISTS `document_yjs_checkpoints` (
...
CREATE UNIQUE INDEX IF NOT EXISTS `document_yjs_checkpoints_document_version_idx` ON `document_yjs_checkpoints` (`document_id`,`through_version`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `document_yjs_checkpoints_document_idx` ON `document_yjs_checkpoints` (`document_id`);--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `document_yjs_updates` (
	`id` text PRIMARY KEY NOT NULL,
	`document_id` text NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `document_yjs_updates_document_version_idx` ON `document_yjs_updates` (`document_id`,`version`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `document_yjs_updates_document_idx` ON `document_yjs_updates` (`document_id`,`version`);--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `document_yjs_versions` (
	`document_id` text NOT NULL,
	`version` integer NOT NULL,
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `document_yjs_versions_update_idx` ON `document_yjs_versions` (`update_id`);--> statement-breakpoint
PRAGMA foreign_keys=OFF;--> statement-breakpoint
DROP TABLE IF EXISTS `__new_doc_versions`;--> statement-breakpoint
