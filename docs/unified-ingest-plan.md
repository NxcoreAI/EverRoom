...
>
> **2026-08-21 后续决策**：本地手动文件和目录扫描文件的存储、版本化解析、连接器文件准入及 FilesPage 聚类，均以当前 `modules/files`、文件格式注册表和 FilesPage 实现为准。本文 U8 中“本地 path 只读不拷贝”的约束仍然有效；U9“modules/files 是唯一字节入口”继续有效。
